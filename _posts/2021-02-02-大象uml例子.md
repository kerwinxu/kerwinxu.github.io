...
[![](images/IMG_20210202_144857-中.jpg)](http://127.0.0.1/?attachment_id=3756)
...
[![](images/图9.1定义边界.TIF.png)](http://127.0.0.1/?attachment_id=3757)

边界有大有小，比如如下的以用电客户服务业务为边界，暂时忽略边界内业务人员的期望。

[![](images/图9.2用电客户服务业务边界.TIF.png)](http://127.0.0.1/?attachment_id=3758)

而如下的是内部管理目标边界。

[![](images/图9.3内部管理目标边界.TIF.png)](http://127.0.0.1/?attachment_id=3759)

## 发现主角

只有那些直接与系统交互的涉众才能被称为业务主角，另一方面，涉众利益可以被多个不同的业务主角代表，一个涉众可以衍生出多个业务主角。

[![](images/图9.5客户服务业务主角.TIF.png)](http://127.0.0.1/?attachment_id=3761)
...
[![](images/图9.7用电客户服务业务概要视图.TIF.png)](http://127.0.0.1/?attachment_id=3762)
...
[![](images/图9.9业务主角业务用例视图.TIF.png)](http://127.0.0.1/?attachment_id=3763)

如下是用活动图描述业务用例场景

[![](images/图9.11低压用电申请业务用例场景.TIF.png)](http://127.0.0.1/?attachment_id=3765)

如下是用时序图描述用例场景

[![](images/图9.13低压用电申请业务用例场景—时序图.TIF.png)](http://127.0.0.1/?attachment_id=3766)

用协作图描述业务用例场景

[![](images/图9.14低压用电申请业务用例场景—协作图.TIF.png)](http://127.0.0.1/?attachment_id=3767)

业务用例实现视图

[![](images/图9.15业务用例实现视图.TIF.png)](http://127.0.0.1/?attachment_id=3768)

业务用例实现场景

业务用例实现着重描述如何通过人机交互来完成业务。

[![](images/图9.16业务用例实现场景-申请登记实现.TIF.png)](http://127.0.0.1/?attachment_id=3769)
...
[![](images/图9.24领域模型与用例模型的关系.TIF.png)](http://127.0.0.1/?attachment_id=3771)
...
[![](images/图10.2核心业务示例图.TIF.png)](http://127.0.0.1/?attachment_id=3772)

然后挑选出关键业务用例

[![](images/图10.3挑选出的关键业务用例.TIF.png)](http://127.0.0.1/?attachment_id=3773)

分析其中一个概念用例

如下时概念用例示例

[![](images/图10.4概念用例示例.TIF.png)](http://127.0.0.1/?attachment_id=3774)

如下时概念场景示例

[![](images/图10.5概念用例场景示例.TIF.png)](http://127.0.0.1/?attachment_id=3775)

 

如下时概念用例对象示例图

[![](images/图10.6概念用例对象示例图.TIF.png)](http://127.0.0.1/?attachment_id=3776)

建立概念模型

[![](images/图10.7分析类场景示例-创建申请单.TIF.png)](http://127.0.0.1/?attachment_id=3777)

如下是加入工作流的分析类场景示例

[![](images/图10.10加入了工作流的分析类场景示例-创建申请单.TIF.png)](http://127.0.0.1/?attachment_id=3778)
