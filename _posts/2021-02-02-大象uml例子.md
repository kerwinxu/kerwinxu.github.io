...
[![]](http://127.0.0.1/?attachment_id=3756)
...
[![]](http://127.0.0.1/?attachment_id=3757)

边界有大有小，比如如下的以用电客户服务业务为边界，暂时忽略边界内业务人员的期望。

[![]](http://127.0.0.1/?attachment_id=3758)

而如下的是内部管理目标边界。

[![]](http://127.0.0.1/?attachment_id=3759)

## 发现主角

只有那些直接与系统交互的涉众才能被称为业务主角，另一方面，涉众利益可以被多个不同的业务主角代表，一个涉众可以衍生出多个业务主角。

[![]](http://127.0.0.1/?attachment_id=3761)
...
[![]](http://127.0.0.1/?attachment_id=3762)
...
[![]](http://127.0.0.1/?attachment_id=3763)

如下是用活动图描述业务用例场景

[![]](http://127.0.0.1/?attachment_id=3765)

如下是用时序图描述用例场景

[![]](http://127.0.0.1/?attachment_id=3766)

用协作图描述业务用例场景

[![]](http://127.0.0.1/?attachment_id=3767)

业务用例实现视图

[![]](http://127.0.0.1/?attachment_id=3768)

业务用例实现场景

业务用例实现着重描述如何通过人机交互来完成业务。

[![]](http://127.0.0.1/?attachment_id=3769)
...
[![]](http://127.0.0.1/?attachment_id=3771)
...
[![]](http://127.0.0.1/?attachment_id=3772)

然后挑选出关键业务用例

[![]](http://127.0.0.1/?attachment_id=3773)

分析其中一个概念用例

如下时概念用例示例

[![]](http://127.0.0.1/?attachment_id=3774)

如下时概念场景示例

[![]](http://127.0.0.1/?attachment_id=3775)

 

如下时概念用例对象示例图

[![]](http://127.0.0.1/?attachment_id=3776)

建立概念模型

[![]](http://127.0.0.1/?attachment_id=3777)

如下是加入工作流的分析类场景示例

[![]](http://127.0.0.1/?attachment_id=3778)
