...
我们还用(list ![$e_{1}$](/assets/image/default/img2.png)...![$e_{n}$](/assets/image/default/img4.png))表示(cons ![$e_{1}$](/assets/image/default/img2.png)...(cons ![$e_{n}$](/assets/image/default/img4.png)'()) ...).
