...
```c#
       ...
       private static void GridLoaded(object sender, RoutedEventArgs e)
 {
  ...
  ```xml
                              <Grid
                               DataContext="{Binding CurrentResistanceMeasurement}"
                               controls:GridOptions.LineBrush="Black"
                               controls:GridOptions.ShowBorder="True"
                               controls:GridOptions.LineThickness="0.5"
       >
```
